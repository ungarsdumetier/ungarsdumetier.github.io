...
function initFindUs() {
  console.log('initFindUs');

  // Find Us map 
  var findUs = new google.maps.Map(document.getElementById("find_us"), {
    zoom: 7,
  ...
  var findHome = new google.maps.Marker({
    position: hauteville,
    map: findUs,
    icon: '/images/home-pin.png'
  });

  var findHome = new google.maps.marker.AdvancedMarkerElement({
    position: hauteville,
    map: findUs,
    icon: '/images/home-pin.png'
  });
